...
*/
var myPhoneNumber = '491773603616'; // Nenad
var myMail = 'nenad.stojanovic@fzi.de'; // Nenad
//
...
var uniqueId = 'onx'+myPhoneNumber+'_'+Math.floor(Math.random()*1000000);
...
event += '			:endTime  &quot;'+new Date().toISOString()+'&quot;^^&lt;http://www.w3.org/2001/XMLSchema#dateTime&gt; ; ';
